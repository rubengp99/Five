...
<div id="chatter" class="chatter_home">
	...
	<div id="chatter_hero">
		...
		<img src="/storage/gtav.png" alt="">
		<strong  style="color:white;font-size:30px;letter-spacing:.7px;font-family:Verdana, Geneva, Tahoma, sans-serif">DISCUSSIONS</strong>
	</div>
